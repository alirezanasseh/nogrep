...
describe('/nogrep:init pipeline integration', () => {
  ...
  it('Step 5 — write.js CLI accepts JSON input and produces .nogrep/', async () => {
    ...
    const distPath = join(import.meta.dirname, '..', 'plugins', 'nogrep', 'scripts', 'write.js')
    await execFileAsync(
      'node',
  ...
  it('Step 1 — signals.js CLI outputs valid JSON to stdout', async () => {
    const distPath = join(import.meta.dirname, '..', 'plugins', 'nogrep', 'scripts', 'signals.js')
  ...
  it('Step 3a — trim.js CLI outputs trimmed source to stdout', async () => {
    const distPath = join(import.meta.dirname, '..', 'plugins', 'nogrep', 'scripts', 'trim.js')
